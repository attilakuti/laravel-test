...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div id="app">
            ...
            <!-- footer -->
            <footer class="bg-white shadow-sm d-flex align-items-center justify-content-center">
                <div class="container">
                    <p class="text-center mb-0 font-weight-bold">Attila Kuti</p>
                </div>
            </footer>
        </div>
        <!-- Scripts -->
        <script>let rootURL = "{{ url('/') }}"; </script>
        ...
        <!-- fontawesome -->
        <script src="https://kit.fontawesome.com/71ec968434.js" crossorigin="anonymous"></script>
    </body>
</html>
